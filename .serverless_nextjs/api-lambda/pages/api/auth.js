...
/******/ 	return __webpack_require__(__webpack_require__.s = "IEly");
/******/ })
/************************************************************************/
/******/ ({
    ...
    function handleRewrites(parsedUrl) {
      ...
      /* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
        try {
          ...
          const resolver = __webpack_require__("f677")
          await apiResolver(
            req,
            res,
...
/* harmony default export */ __webpack_exports__["default"] = (Auth => ({
  ...
  signUp: params => {
    const {
      ...
      password
          ...
          signUpParams = _objectWithoutProperties(params, ["email", "password"]);
  ...
  updateAuthAttributes: (user, attributes) => Auth.updateUserAttributes(user, attributes)
}));
