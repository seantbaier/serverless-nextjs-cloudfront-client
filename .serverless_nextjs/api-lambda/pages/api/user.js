...
/******/ 	return __webpack_require__(__webpack_require__.s = "zAU5");
/******/ })
/************************************************************************/
/******/ ({
...
/* harmony default export */ __webpack_exports__["default"] = ((authEndpointUrl, publicEndpointUrl) => ({
  find: params => {
    ...
    if (params && params.sort) {
      queryParams = Object.assign(queryParams, {
        sort: Object.keys(params.sort).map(key => {
          return params.sort[key].toLowerCase() === 'desc' ? `-${key}` : key;
        }).join(',')
      });
    }

    return axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(publicEndpointUrl(`users`), queryParams).then(response => response.data);
  },
  findById: id => axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(publicEndpointUrl(`users/${id}`), {}).then(response => response.data),
  create: params => axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(authEndpointUrl('users'), params).then(response => response.data),
  update: (id, params) => axios__WEBPACK_IMPORTED_MODULE_0___default.a.put(authEndpointUrl(`users/${id}`), params).then(response => response.data),
  delete: id => axios__WEBPACK_IMPORTED_MODULE_0___default.a.patch(authEndpointUrl(`users/${id}`)).then(response => response.data)
}));
    ...
    function handleRewrites(parsedUrl) {
      ...
      /* harmony default export */ __webpack_exports__["default"] = (async (req, res) => {
        try {
          ...
          const resolver = __webpack_require__("Krtq")
          await apiResolver(
            req,
            res,
            Object.assign({}, parsedUrl.query, params ),
            resolver,
            {previewModeId:"50326dc7246e78629b2d7e40b8818c8b",previewModeSigningKey:"dcba1bf79357ef64267c0eb3884fc38ebbf3db318053fb10d5790da32eba96ac",previewModeEncryptionKey:"84ec1c12ee04b46c6c3d27fe56d6affae91b6cc341deff2f3350a6cabbb38e52"},
